...
const createSmartAccount = async (): Promise<{
  ...
  try {
    ...
    // Generate a fresh private key and wallet
...
const voteOnSepolia = async ({
  ...
  // Build the calldata using encodeFunctionData
  ...
  // Send the transaction via the smart account client
